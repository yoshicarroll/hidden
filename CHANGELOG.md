...
- macOS 27: after displays reconnect the arrow's glyph is redrawn; a display coming back at wake was seen to keep the arrow's slot but lose its image on that display.
...
- macOS 27: diagnostic logging under subsystem `com.dwarvesv.minimalbar` (collapse/expand triggers, screen changes, sleep/wake, MenuBarAgent relaunches, filler placement, a periodic collapsed-state audit); see the runbook.
